...
ServiceLink🌐 Frontend (Vercel)inventory-order-management-lyart.vercel.app⚙️ Backend API (Render)inventory-order-management-etq7.onrender.com🐳 Docker Hubmohhitt45/inventory-backend📁 GitHub RepoMohhitt45/inventory-order-management
...
LayerTechnologiesFrontendReact.js, Vite, Axios, BootstrapBackendFastAPI, SQLAlchemy, PostgreSQL (Neon), UvicornDevOpsDocker, Docker Hub, Render, Vercel
